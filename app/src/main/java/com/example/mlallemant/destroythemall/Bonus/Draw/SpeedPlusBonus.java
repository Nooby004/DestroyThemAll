...
public class SpeedPlusBonus implements BonusInterface {
    ...
    public SpeedPlusBonus(Context context, int width, int height){
        ...
        arrow_left = newHeadArrow(x-radius_circle_center/3,y, 2* radius_circle_center/3, 4*radius_circle_center/3, 1);
        arrow_right = newHeadArrow( x+radius_circle_center/3, y, 2* radius_circle_center/3, 4*radius_circle_center/3, 1);
